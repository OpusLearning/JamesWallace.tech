  ...
  return (
    <div className="credentials-page">
      ...
      <section id="professional-checks" className="jw-section credentials-checks" aria-labelledby="checks-heading">
        <div className="jw-container credentials-checks-grid"><div><p className="jw-eyebrow">05 / Professional checks</p><h2 id="checks-heading">Know who is<br /><em>working with you.</em></h2></div><div><h3>Enhanced DBS on the Update Service</h3><p>Enhanced DBS on the Update Service, verifiable the same day. Safeguarding practice is aligned to {STATUTORY.kcsie}; the policy suite is under review and approved policies are shared on request.</p><p>Documentation packages are available to parents, agencies and local authority teams. Certificates, DBS details and professional references are available on request.</p><p className="credential-date">Information reviewed {REVIEWED}.</p><div className="credentials-checks-actions"><Link to="/contact" className="jw-btn-primary">Request documentation <span aria-hidden="true">→</span></Link><Link to="/compliance" className="jw-text-link">View compliance details <span aria-hidden="true">→</span></Link></div></div></div>
      </section>
    </div>
  );
}
